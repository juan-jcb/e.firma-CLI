...
from efcli.config import STATE_USERS_FILE, CONFIG_DIR
from efcli.xdg import mensajes, bootstrap
from efcli.utils import cripto, regex, registros, wrappers
...
def print_current_user_conf():
    ...
    with registros.modded_logs(target_logger=logger, level=logging.DEBUG):
        ...
        logger.debug("Propietario: %s", leer_subject_simple(cert))
